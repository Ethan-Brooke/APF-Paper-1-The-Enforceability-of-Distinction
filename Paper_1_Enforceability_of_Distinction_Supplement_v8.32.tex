...
\author{E.\,S.\ Brooke}
\date{May 2026 \quad\textbar\quad v8.32}
...
\coderef{check\_T\_PLEC\_derived\_from\_spine}{foundation\_inputs.py}\\
\coderef{check\_T\_four\_input\_declaration}{foundation\_inputs.py}
...
\coderef{check\_T\_R1\_R4\_spine\_derivable}{kappa\_int\_bounds.py}
...
\end{proof}
\coderef{check\_T\_minimum\_distinction\_floor\_via\_MD}{kappa\_int\_bounds.py}
