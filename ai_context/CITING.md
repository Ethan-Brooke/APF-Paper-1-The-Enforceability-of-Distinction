...
> Brooke, E. S. (2026). *The Enforceability of Distinction: Quantum Structure from Finite Enforcement Capacity*. Version v5.2. Zenodo. https://doi.org/10.5281/zenodo.18439200

**BibTeX:**

```bibtex
@misc{brooke_paper1_2026,
  ...
  url          = {https://doi.org/10.5281/zenodo.18439200}
}
```

The DOI `10.5281/zenodo.18439200` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
...
Cite a specific check function as: `check_T7B` (from `apf/gravity.py`, APF codebase v7.8, Brooke 2026).
