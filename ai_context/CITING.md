...
> Brooke, E. S. (2026). *The Enforceability of Distinction: Quantum Structure from Finite Enforcement Capacity*. Version v5.2. Zenodo. https://doi.org/10.5281/zenodo.18604678
...
The DOI `10.5281/zenodo.18604678` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
