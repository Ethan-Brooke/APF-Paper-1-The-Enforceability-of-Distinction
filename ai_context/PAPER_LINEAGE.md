# PAPER_LINEAGE.md — Version History for Paper 1

This file tracks the version history of Paper 1 (The Enforceability of Distinction: Quantum Structure from Finite Enforcement Capacity) and explains the relationship between the version in this release, the version on Zenodo, and any intermediate versions.

---

## Current release

- **Version in this repo:** v5.2
- **File in this repo:** `Paper_1_Enforceability_of_Distinction_v5.2.tex` + `.pdf`
- **Page count:** 48 pp
- **Release date:** 2026-05-05
- **Codebase version at build:** v7.8 (2026-05-04)

## Zenodo record

- **Concept DOI:** 10.5281/zenodo.18439200
...
- **v5.2** (current): see the main paper's changelog section for details.
...
**vv5.2 supersedes all earlier versions** for current reference. If citing for strict reproducibility of work published before this version, cite the version DOI from the specific Zenodo deposit the earlier work used.
...
All `\coderef{check_X}{module.py}` anchors in this paper are valid against codebase v7.8. If you are reading this release against a newer canonical codebase, a handful of checks may have been renamed, merged, or relocated; consult the bank changelog in `apf/__init__.py` of the newer codebase version.

The full codebase is at:
- `__APF Library/Codebase/APF_Codebase_v7.8/` (this release built against this version)
...
*Generated by `create-repo`. The `- **v5.2** (current): see the main paper's changelog section for details.
