...
This is the standalone-repo verifier for The Enforceability of Distinction (APF Paper 1).
...
verifies the 18-theorem subset directly cited by the manuscript.
"""
...
def main():
    ...
    print()
    print("=" * 72)
    print(f"  Paper 1 ({{The Enforceability of Distinction}}): {passed} passed, {failed} failed, "
